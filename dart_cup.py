...
from ui.prodartleague import ProDartLeague
...
SPIEL_MODI = {
    ...
    "Bob's 27": (
        bob.spiel_bobs27,
        bob.init_bobs27,
        ["Classic", "Einsteiger", "Open End"],
        False,
        "standard",
    ),
    "Classic X01": (
        classic.process_classic,
        classic.init_classic,
        ["101", "301", "501", "701", "901"],
        True,
        "standard",
    ),
    "Elimination": (
        elimination.process_elimination,
        elimination.init_elimination,
        ["301", "501", "701"],
        True,
        "collision_detection",
    ),
    "Mensch-ärgere-dich-nicht!": (
        mensch.process_mensch,
        mensch.init_mensch,
        ["301", "501", "701"],
        True,
        "collision_detection",
    ...
    "Cricket": (
        cricket.process_cricket,
        cricket.init_cricket,
        ["Standard", "Cut-Throat", "No-Score"],
        False,
        "standard",
    ),
    "Around the Clock": (
        clock.process_around_the_clock,
        clock.init_around_the_clock,
        ["Standard", "Double-Only", "All-In"],
        False,
        "target_scoring",
    ),
    "Shanghai": (
        shanghai.process_shanghai,
        shanghai.init_shanghai,
        ["Standard", "Double-Only", "Shanghai-Finish"],
        False,
        "target_scoring",
    ),
    "Halve It": (
        halve_it.process_halve_it,
        halve_it.init_halve_it,
        ["Standard", "Kurz", "Pro Challenge"],
        False,
        "standard",
    ),
    "Killer": (
        ...
        killer.init_killer,
        ["Standard", "Direkt-Killer", "Totaler Krieg"],
        False,
        "life_tracking",
    ),
}
