...
class ProDartLeague(QWidget):
    ...
    def execute_bot_throw(self):
        ...
        # Prüfen, ob der Spieler laut Map wirklich eine KI ist
        ...
        # NEU: Double-In/Out Status bestimmen
        # Double In: Wenn Spieler noch nicht eingeworfen hat (has_entered ist False)
        # Double Out: Wenn in den UI-Einstellungen aktiviert
        is_double_in = not self.has_entered[p]
        is_double_out = self.double_out

        # Bot wirft mit den neuen Parametern
